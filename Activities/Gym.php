...
<section class ="landing-page">
   ...
   <br> Write your custom exercises: <br>
   <br>
  <form action="../DataScripts/GymNameSetter.php" method="POST" id="newExerciseForm">
      New exercise:<input type="text" name="exercise" maxlength="64" required=”required” /><br><br>
      <input type="submit" value="Submit new exercise">
  </form><br> </div>
  <?php
      include '../DataScripts/GymDataWriter.php'
  ?>
            </div>
            </div>
        </div>
