...
<section class ="landing-page">
    ...
    <form action="../DataScripts/JoggingDataSenderComparison.php" method="POST">
    <div class="logoptions">
        Distance: [m]<input type="text" name="distance" maxlength="64" required=”required”><br><br>
        Time: [minutes]<input type="text" name="time" maxlength="64" required="required"><br><br>
