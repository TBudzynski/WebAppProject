...
<section class ="landing-page">
    ...
    <form action="../DataScripts/CyclingDataSenderComparison.php" method="POST"><br>
    <div class="logoptions">
        Distance [km]:<br/><br><input type="text" name="distance" maxlength="64" required=”required”><br>
